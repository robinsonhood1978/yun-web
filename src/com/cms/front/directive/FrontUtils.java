...
public class FrontUtils {
	 ...
	 * 操作成功页面
	 */
	public static final String SUCCESS_PAGE_FINANCING = "tpl.successPageFinancing";
	/**
	 * 操作失败页面
	 */
	 ...
	 * 操作失败页面
	 */
	public static final String ERROR_PAGE_FINANCING = "tpl.errorPageFinancing";
	 ...
	 * 标签参数中获得页码。
	 */
	public static int getPageNoP(Map<String, TemplateModel> params)
	        throws TemplateException {
        Integer page = DirectiveUtils.getInt(PAGE_NO, params);
        if (page == null) {
	        return 1;
        } else {
	        return page;
